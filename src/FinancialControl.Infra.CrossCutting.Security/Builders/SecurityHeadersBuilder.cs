using System;
using FinancialControl.Infra.CrossCutting.Security.Constants;
using FinancialControl.Infra.CrossCutting.Security.Policies;

namespace FinancialControl.Infra.CrossCutting.Security.Builders
{
    /// <summary>
    ...
    public class SecurityHeadersBuilder
    {
        ...
        {
            _policy.SetHeaders[FrameOptionsConstant.Header] = FrameOptionsConstant.Deny;
            return this;
        }
        ...
        {
            _policy.SetHeaders[FrameOptionsConstant.Header] = FrameOptionsConstant.SameOrigin;
            return this;
        }
        ...
        {
            _policy.SetHeaders[FrameOptionsConstant.Header] = string.Format(FrameOptionsConstant.AllowFromUri, uri);
            return this;
        }
        ...
        {
            _policy.SetHeaders[XssProtectionConstant.Header] = XssProtectionConstant.Enabled;
            return this;
        }
        ...
        {
            _policy.SetHeaders[XssProtectionConstant.Header] = XssProtectionConstant.Disabled;
            return this;
        }
        ...
        {
            _policy.SetHeaders[XssProtectionConstant.Header] = XssProtectionConstant.Block;
            return this;
        }
        ...
        {
            _policy.SetHeaders[XssProtectionConstant.Header] =
                string.Format(XssProtectionConstant.Report, reportUrl);
            return this;
        }
        ...
        {
            _policy.SetHeaders[StrictTransportSecurityConstant.Header] =
                string.Format(StrictTransportSecurityConstant.MaxAge, maxAge);
            return this;
        }
        ...
        {
            _policy.SetHeaders[StrictTransportSecurityConstant.Header] =
                string.Format(StrictTransportSecurityConstant.MaxAgeIncludeSubdomains, maxAge);
            return this;
        }
        ...
        {
            _policy.SetHeaders[StrictTransportSecurityConstant.Header] =
                StrictTransportSecurityConstant.NoCache;
            return this;
        }
        ...
        {
            _policy.SetHeaders[ContentTypeOptionsConstant.Header] = ContentTypeOptionsConstant.NoSniff;
            return this;
        }
        ...
        {
            _policy.RemoveHeaders.Add(ServerConstant.Header);
            return this;
        }
