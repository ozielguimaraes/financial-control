...
namespace FinancialControl.Infra.CrossCutting.Security.Extensions
{
    public class IdentityPortugueseMessages : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"Login '{userName}' é inválido, pode conter apenas letras ou dÃ­gitos." }; }
